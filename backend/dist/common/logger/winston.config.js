...
const winstonConfig = {
    transports: [
        new _winston.transports.Console({
            format: _winston.format.combine(_winston.format.timestamp(), _winston.format.ms(), _nestwinston.utilities.format.nestLike('WardrobeAI', {
                prettyPrint: true
            }))
        })
    ]
};
const LoggerModule = _nestwinston.WinstonModule.forRoot(winstonConfig);
