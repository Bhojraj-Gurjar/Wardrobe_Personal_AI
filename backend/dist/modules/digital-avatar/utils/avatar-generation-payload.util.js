...
Object.defineProperty(exports, "buildAvatarGenerationPayload", {
    enumerable: true,
    get: function() {
        return buildAvatarGenerationPayload;
    }
});
function buildAvatarGenerationPayload(context, avatarType) {
    const face = context.faceTraits || {};
    const body = context.bodyTraits || {};
    const profile = context.profile || null;
    const skinTone = face.skin_tone || face.skinTone || profile?.skin_tone || null;
    return {
        avatarType,
        faceAnalysis: {
...
//# sourceMappingURL=avatar-generation-payload.util.js.map