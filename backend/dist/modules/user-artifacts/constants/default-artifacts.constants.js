...
_export(exports, {
    get DEFAULT_AVATAR_METADATA () {
        return DEFAULT_AVATAR_METADATA;
    },
    get DEFAULT_BODY_ANALYSIS () {
        return DEFAULT_BODY_ANALYSIS;
    },
    get DEFAULT_BODY_MEASUREMENTS_INCHES () {
        return DEFAULT_BODY_MEASUREMENTS_INCHES;
    },
    get DEFAULT_FACE_ANALYSIS () {
        return DEFAULT_FACE_ANALYSIS;
    },
    get DEFAULT_FASHION_DNA () {
        return DEFAULT_FASHION_DNA;
    },
    get buildDefaultAvatarSvg () {
        return buildDefaultAvatarSvg;
    }
});
const DEFAULT_FACE_ANALYSIS = {
    face_shape: 'Oval',
    skin_tone: 'Medium',
...
const DEFAULT_BODY_MEASUREMENTS_INCHES = {
    height: 70,
    shoulder: 18,
    chest: 40,
    waist: 32,
...
const DEFAULT_BODY_ANALYSIS = {
    ...
    raw_ai_response: {
        ...
        measurements: {
            height: {
                value: inchToCm(DEFAULT_BODY_MEASUREMENTS_INCHES.height),
                normalized: 0.82
            },
            shoulderWidth: {
                value: inchToCm(DEFAULT_BODY_MEASUREMENTS_INCHES.shoulder),
                normalized: 0.85
            },
            chest: {
                value: inchToCm(DEFAULT_BODY_MEASUREMENTS_INCHES.chest),
                normalized: 0.84
            },
            waist: {
                value: inchToCm(DEFAULT_BODY_MEASUREMENTS_INCHES.waist),
                normalized: 0.72
            },
            hip: {
                value: inchToCm(DEFAULT_BODY_MEASUREMENTS_INCHES.hip),
                normalized: 0.78
            },
            armLength: {
                value: inchToCm(DEFAULT_BODY_MEASUREMENTS_INCHES.armLength),
                normalized: 0.8
            },
            legLength: {
...
//# sourceMappingURL=default-artifacts.constants.js.map