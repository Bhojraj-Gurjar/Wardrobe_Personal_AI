...
class Settings(BaseSettings):
    ...
    face_liveness_blur_variance: float = 28.0
    face_liveness_min_detection_score: float = 0.38
    ...
    face_hold_still_min_detection_score: float = 0.80
    face_min_area_ratio: float = 0.10
    face_max_area_ratio: float = 0.50
    face_guide_margin_ratio: float = 0.10
    face_anti_spoof_min_motion: float = 0.7
    face_anti_spoof_min_frame_diff: float = 1.1
    face_anti_spoof_max_specular_ratio: float = 0.30
    face_anti_spoof_max_moire_ratio: float = 6.0
    face_min_embedding_confidence: float = 0.40
